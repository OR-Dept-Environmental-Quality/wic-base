...
However, if you are interested in the actual exports from GaBi, you can find them here in the "current" folder.  If you find the current folder empty except for a zip file, you may need to extract the zip file into the same folder on your local machine.  The reason for this inconvenience: GaBi's exports are too large to push directly to github, so the actual export filespecs have been placed in the .gitignore.  However, a compressed version of the files is small enough to be manageable.  
